...
namespace CRUDReactMVC.Server.Controllers
{
    ...
    public class ContactoController : ControllerBase
    {
       private readonly CrudreactMvcContext _context;
        ...
        {
            await _context.Contactos.AddAsync(request); //Guarda los datos únicamente en el modelo
            await _context.SaveChangesAsync(); //Guarda la información a la base de datos 
